...
RUN apt-get update && \
	mkdir -p /usr/share/man/man1 /usr/share/man/man7 && \
        apt-get -y install --no-install-recommends postgresql-client=11+200+deb10u1 wget=1.20.1-1.1 libgdal20=2.4.0+dfsg-1+b1 build-essential=12.6 libpq-dev=11.5-1+deb10u1 mime-support=3.62 && \
	apt-get clean && \
